...
plt.figure(1,figsize = (8,8)) #Creates a figure for chapter 7.1a
...
plt.savefig('computer-lab-2-7.1a-nico-baldovino.pdf')  #saves figure 1 as a .pdf file in our working directory  
...
fig.savefig('computer-lab-2-7.1b-nico-baldovino.pdf') #saves figure 2 as a .pdf file in our working directory
...
plt.axis('square')
plt.axis('equal')
plt.savefig('computer-lab-2-7.2a.2-nico-baldovino.pdf')
...
plt.savefig('computer-lab-2-7.2b-nico-baldovino.pdf')
...
plt.xlabel('Number of Steps')
plt.ylabel('Frequency')
plt.savefig('computer-lab-2-7.2c-nico-baldovino.pdf')
...
plt.xlabel('Steps')
plt.ylabel('Frequency')
plt.savefig('computer-lab-2-7.2d.1-nico-baldovino.pdf')
...
plt.xlabel('Steps')
plt.ylabel('Frequency')
plt.savefig('computer-lab-2-7.2d.2-nico-baldovino.pdf')
...
plt.axis('square')
plt.axis('equal')
plt.savefig('computer-lab-2-7.2f.1-nico-baldovino.pdf')
...
plt.xlabel('Number of Steps')
plt.ylabel('Frequency')
plt.savefig('computer-lab-2-7.2f.2-nico-baldovino.pdf')
...
plt.xlabel('Number of Steps')
plt.ylabel('Frequency')
plt.savefig('computer-lab-2-7.2f.3-nico-baldovino.pdf')
...
plt.xlabel('Steps')
plt.ylabel('Frequency')
plt.savefig('computer-lab-2-7.2f.4-nico-baldovino.pdf')
...
plt.xlabel('Steps')
plt.ylabel('Frequency')
plt.savefig('computer-lab-2-7.2f.5-nico-baldovino.pdf')
